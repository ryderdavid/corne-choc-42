// Corne Choc 42-Key — QWERTY Profile
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO,        KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_ENT,
    ...
    [_SYMBOLS] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_SCLN, KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,      KC_TRNS, KC_MINS, KC_UNDS, KC_EQL,  KC_PLUS, KC_TRNS,
